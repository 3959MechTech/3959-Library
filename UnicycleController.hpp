...
/* )Author: Austin
   ...
   )Description: This code helps to navigate the field in auto. Through out this code many things used or created. One of two things are the variables x and y. Both
